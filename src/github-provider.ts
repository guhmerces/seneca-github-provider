...
function GithubProvider(this: any, _options: any) {
  ...
  seneca
    ...
    .message('role:entity,cmd:load,zone:provider,base:github,name:release', commands.release.load_release)
    .message('role:entity,cmd:save,zone:provider,base:github,name:release', commands.release.save_release)
