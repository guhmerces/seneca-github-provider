...
function GithubProvider(this: any, _options: any) {
  ...
  seneca
    ...
    .message('role:entity,cmd:load,zone:provider,base:github,name:gist', commands.gist.load_gist)
    .message('role:entity,cmd:save,zone:provider,base:github,name:gist', commands.gist.save_gist)
