...
function GithubProvider(this: any, _options: any) {
  ...
  seneca
    ...
    .message('role:entity,cmd:load,zone:provider,base:github,name:project', commands.project.load_project)
    .message('role:entity,cmd:save,zone:provider,base:github,name:project', commands.project.save_project)
